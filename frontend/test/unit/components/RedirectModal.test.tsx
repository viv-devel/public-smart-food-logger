...
describe("RedirectModal", () => {
  it("does not render when isOpen is false", () => {
    ...
    render(
      <RedirectModal isOpen={false} onClose={onClose} onConfirm={onConfirm} />,
    );
  ...
  it("renders correctly when isOpen is true", () => {
    ...
    const onConfirm = vi.fn();
    render(
      <RedirectModal isOpen={true} onClose={onClose} onConfirm={onConfirm} />,
    );

    expect(
      screen.getByRole("button", { name: "食事の記録を登録する" }),
    ).toBeDefined();
